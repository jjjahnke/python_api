...
class DBCore(BaseModel):
    ...
    created_at: Union[datetime.datetime, None] = Field(default_factory=datetime.datetime.now)
    updated_at: Union[datetime.datetime, None] = Field(default_factory=datetime.datetime.now)
